...
def load_model_file(checkpoint_dir):
    MODEL_DIR = '/a/bear.cs.fiu.edu./disk/bear-b/users/mkhan149/Downloads/Experiments/Others/MMNR/runs_cr_genrec_v1/' + checkpoint_dir
    ...
    for name in names:
        if int(name[6:8]) >= max_epoch:
            ...
            choose_model = name
    MODEL_FILE = '/a/bear.cs.fiu.edu./disk/bear-b/users/mkhan149/Downloads/Experiments/Others/MMNR/runs_cr_genrec_v1/' + checkpoint_dir + '/' + choose_model
